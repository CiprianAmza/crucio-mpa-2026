...
export type SubmissionDetail = {
  ...
  isVoice: boolean;
  answerText: string;
  feedback: string; // JSON-stringified Evaluation
  createdAt: Date | string;
  problemTitle?: string;
};

function safeParseFeedback(raw: string): Evaluation | null {
  try {
...
export function SubmissionDetailDialog({
  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="max-w-2xl max-h-[85vh] overflow-y-auto bg-gradient-to-br from-rose-950/30 to-black border-rose-500/30">
        <DialogHeader>
